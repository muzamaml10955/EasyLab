      ...
      webView.getSettings().setRenderPriority(WebSettings.RenderPriority.HIGH);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                Toast.makeText(getContext(), "Failed loading app!, No Internet Connection found.", Toast.LENGTH_LONG).show();
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.contains("https://easylab.pk/")) {
                    ...
                    if (url.contains("intent://user/117510536301396/?intent_trigger=mme&nav=discover&source=customer_cha")) {
         ...
         /*   @Override
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.startsWith("intent://user/117510536301396/?intent_trigger=mme&nav=discover&source=customer")) {
                    Log.d("muzammal2",url);
                  //  Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(   ));

                    try {
                       Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("fb-messenger://user/117510536301396"));
                        Log.d("muzammal1",url);
                        startActivity(i);
                    } catch (android.content.ActivityNotFoundException e) {
                        Intent notificationIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://m.me/117510536301396"));
                        Log.d("muzammal2",url);
