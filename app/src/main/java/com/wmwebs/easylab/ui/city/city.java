...
public class city extends Fragment {
    String url = "https://easylab.pk/citi-lab/";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        webView = root.findViewById(R.id.chughtaiewebview);
        swipeRefreshLayout = root.findViewById(R.id.chughtaieswiperefreshayout);
